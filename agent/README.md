...
| `src/agents/phishing-triage.ts` | Loads the shared assessment instructions, registers the provider, structured assessment submission and optional passage comparison. |
