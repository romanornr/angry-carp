...
[ADR 0014](0014-keep-provider-routing-outside-ai-assessment.md) gives local Flue assessment a narrower task and instruction document while preserving this standalone workflow and the shared reporting guide.
