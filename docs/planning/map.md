...
Report-preparation research remains deferred under issue 18. Unsupported HTML, fresh authentication verification and payload examination remain explicit coverage limits, not newly authorized expansion. The smaller wording gap can be addressed next without adding another model pass to routine analysis.
